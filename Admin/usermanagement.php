    ...
    <div class="wrapper">
        ...
        <h5 style="font-weight:bold; font-size:25px; text-align: center;">Journal Entry Voucher Management System</h5>
            ...
            <div class="card">
                <div class="card-header" style="background-color:#0e2238;">
                    <div class="d-flex mt-1 p-2">
                        <h3 style="font-weight:bold; color:white;"><i class="lni lni-user"></i> User Management</h3>
                    </div>
                </div>
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="d-flex">
                    <div>
                        <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#addUsers" style="margin-right:10px;">Add Users</button>
                    </div>
                    <div class="col-md-3">
